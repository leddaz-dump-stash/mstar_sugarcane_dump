...
cp /vendor/pqfiles/K750WD90_BC550A1/Customer_1_AL.ini    /tvconfig/config/model/Customer_1.ini
cp /vendor/pqfiles/K750WD90_BC550A1/Main.bin             /tvconfig/config/pq/Main.bin
cp /vendor/pqfiles/K750WD90_BC550A1/Main_Text.bin        /tvconfig/config/pq/Main_Text.bin
cp /vendor/pqfiles/K750WD90_BC550A1/Main_Color.bin       /tvconfig/config/pq/Main_Color.bin
cp /vendor/pqfiles/K750WD90_BC550A1/Main_Color_Text.bin  /tvconfig/config/pq/Main_Color_Text.bin
cp /vendor/pqfiles/K750WD90_BC550A1/HSY.bin              /tvconfig/config/pq/HSY.bin
cp /vendor/pqfiles/K750WD90_BC550A1/Main_TMO.bin         /tvconfig/config/pq/Main_TMO.bin
cp /vendor/pqfiles/K750WD90_BC550A1/Main_TMO_Text.bin    /tvconfig/config/pq/Main_TMO_Text.bin
cp /vendor/pqfiles/K750WD90_BC550A1/factory.db           /tvdatabase/Database/factory.db
cp /vendor/pqfiles/K750WD90_BC550A1/factory.db           /tvdatabase/DatabaseBackup/factory.db
cp /vendor/pqfiles/K750WD90_BC550A1/factory.db           /tvconfig/TvBackup/Database/factory.db
cp /vendor/pqfiles/K750WD90_BC550A1/customer.db          /tvdatabase/Database/customer.db
cp /vendor/pqfiles/K750WD90_BC550A1/customer.db          /tvdatabase/DatabaseBackup/customer.db
cp /vendor/pqfiles/K750WD90_BC550A1/customer.db          /tvconfig/TvBackup/Database/customer.db
